package com.UB.DiningHallSystem.controller;
...
public class apiController {
    ...
    @PostMapping("/user/addEatCoin")
    public ResponseEntity<String> addEat(@RequestBody String count){
        return ResponseEntity.ok().body(userService.addEat(Integer.parseInt(count)));
    }

    @PostMapping("/user/eat")
    public ResponseEntity<String> eat(){
        return ResponseEntity.ok().body(userService.eat());
    }
